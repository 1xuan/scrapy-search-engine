...
class LagouSpider(CrawlSpider):
    ...
    def parse_job(self, response):
        ...
        item_loader.add_xpath('title', '//div[@class="job-name"]/span/text()')
        item_loader.add_value('url', response.url)
        item_loader.add_value('url_object_id', get_md5(response.url))
        item_loader.add_xpath('salary', '//span[@class="salary"]/text()')
        item_loader.add_xpath('job_city', '//span[@class="salary"]/../span[2]/text()')
        item_loader.add_xpath('work_years', '//span[@class="salary"]/../span[3]/text()')
        item_loader.add_xpath('degree_need', '//span[@class="salary"]/../span[4]/text()')
        item_loader.add_xpath('job_type', '//span[@class="salary"]/../span[5]/text()')
        ...
        item_loader.add_xpath('job_addr', '//div[@class="work_addr"]/a[position()<last()]/text()')
